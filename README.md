...
<img src="https://github.com/aditya226-sharma.png" width="200" style="border-radius: 50%; border: 4px solid #00d4ff; box-shadow: 0 0 30px rgba(0, 212, 255, 0.6);" alt="Aditya Sharma"/>
...
```mermaid
timeline
    title Aditya Sharma's Cybersecurity Journey
    2023 : Started Programming : Built First Website
    2024 : Started Cybersecurity : Built First Security Tool
    2024 : Participated in Hackathons : Started Technical Writing
    2025 : Open Source Contributions : AI Security Projects
